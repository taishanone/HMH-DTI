...
from sklearn.metrics import precision_recall_curve, auc,roc_curve,f1_score, recall_score, precision_score, \
...
def evaluate(label, predict):
    ...
    # return AUC, AUPR, ACC, Recall, Precision, f1, specificity, pred[:, 1], pred_cls
    return (AUC, AUPR, ACC, Recall, Precision, f1)
